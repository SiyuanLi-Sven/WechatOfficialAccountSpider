...
# 登录微信PC端获取文章信息
    f0 = open('湖南社会科学','w',encoding='utf-8-sig',newline='')
    temp_writer = csv.writer(f0)

    appmsg_token = r'1198_P%2Fit07y5MZMW4QzFYDJ7vYwT1dCfDYtyViZUg31JCOVBWujD8QxTv6sjqbjePY2gvrHH0kjhWvOz04QD'
    cookie = r"rewardsn=; wxtokenkey=777; wxuin=2817795206; devicetype=Windows10x64; version=6307001d; lang=zh_CN; appmsg_token=1198_P%2Fit07y5MZMW4QzFYDJ7vYwT1dCfDYtyViZUg31JCOVBWujD8QxTv6sjqbjePY2gvrHH0kjhWvOz04QD; pass_ticket=LkJQlPOaIPUr4StY2lqBG2hdX45alc4dHxLtrAf3U9Qn07Hp2JQuegknxoqxzv++gSmslxARuRFiWTj4jM1n2A==; wap_sid2=CIbJ0L8KEooBeV9ITHhQRzhvX2dwQmZDTE12X3ZIV3UyQVVhQkF5Yy1EWUc0cXZWNlpmcW5feml3MGtWMldJRURjT0NMVXpxVi03ajlfRGoxelNQWGplLWN6YlZZaGxWcWdGNlZDaHlDc2xkaFdSaDZKcHFtYUNRN1Foblo4cUJDdkphaEcwOV9mMHpZc1NBQUF+MKKOsJ0GOA1AAQ=="
    main('湖南社会科学',appmsg_token,cookie)
