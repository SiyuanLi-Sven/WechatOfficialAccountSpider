...
for index,row in df0.iterrows():
    try:
            ...
            for i in comments['elected_comment']:
                ...
                if i.__contains__('reply_new') and i['reply_new'].__contains__('reply_list'):
                    if i['reply_new']['reply_list'] != []:
                        ...
                        lis_auther_like_num.append(i['reply_new']['reply_list'][0]['reply_like_num'])
                    else:
                        lis_auther_reply.append(np.nan)
                        lis_auther_like_num.append(np.nan)
        ...
        df0.loc[index,'lis_auther_reply'] = '☀'.join(lis_like_num)
        df0.loc[index,'lis_auther_like_num'] = '☀'.join(lis_like_num)
