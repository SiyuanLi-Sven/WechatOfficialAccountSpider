    ...
    try:
        ...
        for index,row in df0.iterrows():
            try:
                ...
                print('总长度：{} 已完成：{} 比例：{} 期望时间：{}min'.format(len(df0),count,count/len(df0),-(count-len(df0))*1.5/60))
...
# 登录微信PC端获取文章信息
    f0 = open('temp1206.csv','w',encoding='utf-8',newline='')
    temp_writer = csv.writer(f0)

    appmsg_token = r'1194_tWoXqG4nzDlb8o%2BfymXKWxuB_htO-qDrdnBCWzLw3OOwVMLJEWmYBbbPD0PdrKKpRCYO-BJWfpMhq-CI'
    cookie = r"rewardsn=; wxtokenkey=777; wxuin=2817795206; devicetype=Windows10x64; version=6307001d; lang=zh_CN; appmsg_token=1194_tWoXqG4nzDlb8o%2BfymXKWxuB_htO-qDrdnBCWzLw3OOwVMLJEWmYBbbPD0PdrKKpRCYO-BJWfpMhq-CI; pass_ticket=GGVGvLCnPGq26zOEXzk4n1yc4OHqIkx2ZnF4AQfvkmNJ0+W81MLCMq5o8WtOTcAK; wap_sid2=CIbJ0L8KEooBeV9ISUVpeEpJYnh1Y0hQbFlRZGJGRU5kUWhLUDgzOGhzQ2FpUmZudTFMUDVUUF9ONERuMTJsdkVmdFNJYW9kS0tzalJXTFdwbVdMaU53em82UkdGZm0xRGkyMnRzSGpZeExEUTJreXBKOEM5bXZSd2dNMjlvVEpzczhsc21VRGRtc3JvZ1NBQUF+MNXhupwGOA1AAQ=="
    main('文化纵横202101-202008',appmsg_token,cookie)
