    ...
    try:
        ...
        if len(comments['elected_comment']) > 0:
            for i in comments['elected_comment']:
                ...
                if i.__contains__('reply_new') and i['reply_new'].__contains__('reply_list') and i['reply_new']['reply_list'].__contains__('content'):
                    if len(i['reply_new']['reply_list']) > 0:
                        lis_auther_reply.append(i['reply_new']['reply_list']['content'])
                else:
                    lis_auther_reply.append(np.nan)
        print(lis_content)
        print(lis_like_num)
