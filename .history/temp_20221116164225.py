    ...
    try:
        ...
        if len(comments['elected_comment']) > 0:
            for i in comments['elected_comment']:
                ...
                if 'reply_new' in comments['elected_comment']:
                    print(comments['elected_comment']['reply_list'])
                    if len(comments['elected_comment']['reply_list']) > 0:
                        lis_auther_reply.append(comments['elected_comment']['reply_list'])
                else:
